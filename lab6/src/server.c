  ...
  while (true) {
    ...
    case 0: {
      ...
      case 1:
        tnum = atoi(optarg);
        if (tnum <= 0) {
          fprintf(stderr, "tnum must be a positive number\n");
          return 1;
        }
        break;
      default:
